...
BEGIN
	...
	select @userId = USER_ID from dbo.Login where USER_NAME = @userName;

	If (@userId is null)
	BEGIN
		INSERT INTO dbo.Login (User_Name, User_Password, OAuth_Token, Oauth_Expiration_date, Instance_Url, OAuth_Refresh_Token)
